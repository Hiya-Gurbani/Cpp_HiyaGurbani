...
namespace Constants {
    ...
    inline const std::string MSG_MATRIX2_DIMENSION = "\nMatrix 2 Dimensions: \n";
    ...
    inline const std::string MSG_INVALID_DIMENSIONS = "Invalid Dimensions: Number of columns of first matrix should be equal to rows of second matrix to be multiplied.\n";
